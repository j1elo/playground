...
;; Parte 0: creacion y manejo de arboles aleatorios. Codigo dado en el enunciado.
;; Autores: Juan Navarro Moreno
;;          Antonio Gonzalez Huete
;;          Grupo MD, pareja 06
;;
;; Notas: Revision completa de las practicas para el examen de Septiembre.
;;        Este fichero es cargado automaticamente por la parte 1 de la practica.
...
(defun random.sort (l)
  "Reordena aleatoriamente la lista l, sin modificar l."
  (mapcar #'car
